...
# Compute current log price from actual C1 price
current_log_price <- log(current_price / model_a_objects$current_cpi * 100)

gap_dollars <- (exp(current_log_price) -
